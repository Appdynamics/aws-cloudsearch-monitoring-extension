...
##Use Case
Captures CloudSearch statistics from Amazon CloudWatch and displays them in the AppDynamics Metric Browser.
...
Always feel free to fork and contribute any changes directly via [GitHub](https://github.com/Appdynamics/aws-cloudsearch-monitoring-extension).
